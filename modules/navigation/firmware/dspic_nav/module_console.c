    ...
    switch(key_input) {
        ...
        case KP_ROT_PUSH:
            switch(idx) {
                ...
                case 2: idx=0;jdx=settings.param[0].pid; return menu_fnc_changeid(0,0x00);
                case 3: idx=0;memcpy(tmp_str,settings.param[0].name,8); return menu_fnc_changename(0,0x00);
            }
            break;
    }
